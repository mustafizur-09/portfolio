...
export default function GalleryView() {
  ...
  return (
    <section className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto min-h-screen">
      ...
      {/* Gallery Bento Grid with Framer Motion Animation */}
        ...
        <AnimatePresence mode="popLayout">
          {filteredItems.map((item: GalleryItem) => (
            <motion.div
              ...
              className="bg-zinc-900/60 backdrop-blur-md rounded-2xl border border-zinc-800 hover:border-orange-500/40 transition-all duration-300 flex flex-col justify-between group hover:shadow-[0_0_35px_rgba(234,88,12,0.14)] hover:-translate-y-1 relative overflow-hidden"
            >
              {/* Top Image Container */}

export const portfolioData = {
  hero: {
    ...
    socials: {
      ...
      linkedin: "https://linkedin.com/in/mustafijur-rahman-6431a7253/",
      email: "mailto:mustafijurrahman40496@gmail.com"
    }
  },
  experience: [
    {
  ...
  education: [
    {
      ...
      duration: "Graduated",
      details: "Completed thesis with a focus on advanced machine learning applications.",
    }
  ],
  publications: [
    {
      title: "Medical Action Recognition",
      publisher: "BAUET Thesis",
      date: "2023",
  ...
  skills: [
    ...
    "Tailwind CSS", "Machine Learning", "Python", "Automated Testing", 
    "Selenium", "Manual Testing", "Git", "SQL"
  ],
  leadership: [
    {
      ...
      duration: "2021 - 2022",
      description: "Organized technical workshops, led a team of 15 members to develop community projects, and mentored junior students in programming."
    }
  ],
